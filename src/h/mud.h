...
typedef enum
{
    ...
    ACT_SIGILIST, ACT_CRAFTSHOP, ACT_SHIPWRIGHT,
    ACT_BEASTMELD, ACT_BEASTPET, MAX_ACT
} act_types;
...
typedef enum
{
    ...
    AFF_PHASE, AFF_TANGLE, AFF_ARMOR, AFF_DISGUISE, AFF_ANIMALFORM, AFF_INFECTIOUS_CLAWS, AFF_R123,
    AFF_R124, AFF_R125,
    AFF_R126, AFF_R127,
    MAX_AFFECTED_BY
} affected_by_types;
...
// Anillo bodas.
#define OBJ_VNUM_anillo		59000
#define OBJ_VNUM_anillodragon		59001
...
typedef enum
{
    ...
    ITEM_NOGROUP, ITEM_ROJO, ITEM_AZUL, ITEM_PURPURA, ITEM_AMARILLO, ITEM_BLANCO, ITEM_AZULOSCURO, ITEM_VERDE, ITEM_AZULCLARO, ITEM_VERDEOSCURO, ITEM_CYAN, ITEM_ROSA, ITEM_ROJOOSCURO, ITEM_GRIS, ITEM_GRISOSCURO, ITEM_NARANJA, MAX_ITEM_FLAG
} item_extra_flags;
...
typedef enum
{
    ...
    PLR_EXTREME, PLR_NORENAME, PLR_COMMUNICATION, PLR_CRAFTS, PLR_AUTORECAST, PLR_R65, PLR_R66, PLR_R67,
    PLR_R68,
    PLR_R69, PLR_R70, PLR_R71, PLR_R72, PLR_R73, PLR_R74, PLR_R75, PLR_R76,
    PLR_R77,
    PLR_R78, PLR_R79, PLR_R80, PLR_R81, PLR_TELLOFF
} player_flags;
...
struct obj_data
{
    ...
    char                   *previewcorpse;  // ability to see description of mob that was killed prior on corpse
    long long int guid;
};
...
extern short            gsn_sharpen_claws;
...
{ \
    ...
    { \
  send_to_char("No puedes usar este comando mientras esperas otros.\n\r", ch); \
  return; \
    } \
} while(0)

#define error(ch) send_to_char("&W¿Huh? - Escribe bien el comando.&D\n\r", (ch));
...
DECLARE_DO_FUN( do_casar );
DECLARE_DO_FUN( do_divorciar );
DECLARE_DO_FUN( do_irpareja );
DECLARE_DO_FUN( do_cpareja );
...
DECLARE_DO_FUN( do_sharpen_claws );
...
DECLARE_DO_FUN( do_hog_affinity );
...
bool can_dye_obj       args( ( CHAR_DATA *ch, OBJ_DATA *obj ) );
