...
void do_copyover( CHAR_DATA *ch, char *argument )
{
    ...
    snprintf( buf, 100,
              "\r\n¡El flujo del tiempo se detiene mientras los reinos se reconstruyen!\r\n" );
...
//      act(AT_MAGIC, "$n appears in a puff of ethereal smoke!", puppet, NULL, NULL, TO_ROOM);   TOO SPAMMY!!
         ...
         */
        if ( !write_to_descriptor_old( desc, "\r\nEl mundo se convierte en un caos.\r\n", 0 ) ) {
        ...
        if ( !fOld ) {                                 /* Player file not found?! */
            ...
            write_to_descriptor( d, "\r\nTras unos segundos todo vuelve a la normalidad.\r\n", 0 );
...
//    char_from_room( d->character );
            ...
            act( AT_MAGIC, "¡Un humo púrpura te rodea y luego desaparece!", d->character, NULL,
                 NULL, TO_CHAR );
            act( AT_MAGIC, "¡$n aparece en una nube de humo púrpura!", d->character, NULL, NULL,
                 TO_ROOM );
