...
/*
    ...
    */
     ...
     */
    {
        ...
        ASSIGN_GSN( gsn_cannibalize, "canibalizar" );
        ASSIGN_GSN( gsn_control, "control" );
        ASSIGN_GSN( gsn_marble_skin, "piel de marmol" );
        ASSIGN_GSN( gsn_granite_skin, "piel de granito" );
        ASSIGN_GSN( gsn_break, "romper" );
        ASSIGN_GSN( gsn_brain_boil, "hervir cerebro" );
        ASSIGN_GSN( gsn_death_embrace, "death embrace" );
        ASSIGN_GSN( gsn_disguise, "disfrazar" );
        ASSIGN_GSN( gsn_heart_grab, "heart grab" );
        ASSIGN_GSN( gsn_double_slash, "ataque doble" );
        ASSIGN_GSN( gsn_glacial_armor, "armadura glacial" );
        ASSIGN_GSN( gsn_mitigate, "mitigar" );
        ASSIGN_GSN( gsn_behead, "decapitar" );
        ASSIGN_GSN( gsn_remember, "recordar" );
        ASSIGN_GSN( gsn_flint_fire, "pedernal" );
        ASSIGN_GSN( gsn_brittle_bone, "huesos de cristal" );
        ASSIGN_GSN( gsn_festering_wound, "herida infestada" );
        ASSIGN_GSN( gsn_dehydrate, "desidratar" );
        ASSIGN_GSN( gsn_dye, "tintar" );
        ASSIGN_GSN( gsn_druidic_hymn, "inmunidad druidica" );
        ASSIGN_GSN( gsn_shriek, "chillido" );
        ASSIGN_GSN( gsn_shrieking_note, "notas disonantes" );
        ASSIGN_GSN( gsn_harmonic_melody, "melodia armonica" );
        ASSIGN_GSN( gsn_human_form, "forma humana" );
        ASSIGN_GSN( gsn_evac_crescendo, "evac crescendo" );
        ASSIGN_GSN( gsn_thunderous_hymn, "sonido destructor" );
        ASSIGN_GSN( gsn_stirring_ballad, "balada agitadora" );
        ASSIGN_GSN( gsn_ottos_dance, "danza irresistible" );
        ASSIGN_GSN( gsn_unholy_melody, "melodia profana" );
        ASSIGN_GSN( gsn_sound_waves, "ondas sonoras" );
        ASSIGN_GSN( gsn_rousing_tune, "inspiracion heroica" );
        ASSIGN_GSN( gsn_silence, "silencio" );
        ASSIGN_GSN( gsn_telepathy, "telepatia" );
        ASSIGN_GSN( gsn_heavens_blessing, "bendicion del cielo" );
        ASSIGN_GSN( gsn_shapeshift, "cambiarforma" );
        ASSIGN_GSN( gsn_shield, "escudo" );
        ASSIGN_GSN( gsn_higher_magic, "conjuros poderosos" );
        ASSIGN_GSN( gsn_sanctuary, "santuario" );
        ASSIGN_GSN( gsn_hardened_scales, "escamas endurecidas" );
        ASSIGN_GSN( gsn_thick_hide, "piel gruesa" );
        ASSIGN_GSN( gsn_bark_skin, "piel de corteza" );
        ASSIGN_GSN( gsn_wings, "alas" );
        ASSIGN_GSN( gsn_demonic_sight, "vista demoniaca" );
        ASSIGN_GSN( gsn_fury, "furia" );
        ASSIGN_GSN( gsn_ensnare, "atrapar" );
        ASSIGN_GSN( gsn_layhands, "manos sanadoras" );
        ASSIGN_GSN( gsn_endurance, "resistencia" );
        ASSIGN_GSN( gsn_sidestep, "desequilibrar" );
        ASSIGN_GSN( gsn_daze, "aturdir" );
        ASSIGN_GSN( gsn_recoil, "agresividad" );
        ASSIGN_GSN( gsn_keen_eye, "golpes precisos" );
        ASSIGN_GSN( gsn_defensive_posturing, "defenderse" );
        ASSIGN_GSN( gsn_boost, "boost" );
        ASSIGN_GSN( gsn_martial_arts, "artes marciales" );
        ASSIGN_GSN( gsn_biofeedback, "descanso regenerativo" );
        ASSIGN_GSN( gsn_regenerate, "regenerar" );
        ASSIGN_GSN( gsn_serenity, "serenidad" );
        ASSIGN_GSN( gsn_untangle, "desatar" );
        ASSIGN_GSN( gsn_iron_skin, "piel metalica" );
        ASSIGN_GSN( gsn_impale, "empalar" );
        ASSIGN_GSN( gsn_sustain_self, "sustain self" );
        ASSIGN_GSN( gsn_root, "enraizar" );
        ASSIGN_GSN( gsn_acidic_touch, "toque acido" );
        ASSIGN_GSN( gsn_entangle, "coletazo" );
        ...
        ASSIGN_GSN( gsn_pawn, "marca" );
        ASSIGN_GSN( gsn_wailing, "lamentos" );
        ASSIGN_GSN( gsn_flamebreath, "respirarfuego" );
        ASSIGN_GSN( gsn_energy_containment, "contenedor energetico" );
        /*
         * new gsn assigns for the new weapon skills - Grimm
         */
        ASSIGN_GSN( gsn_pugilism, "pugilism" );
        ASSIGN_GSN( gsn_2h_long_blades, "armas largas mejoradas" );
        ...
        ASSIGN_GSN( gsn_talons, "garras" );
        ASSIGN_GSN( gsn_polearms, "poleas" ); // revisar

        ASSIGN_GSN( gsn_detrap, "detrap" );
        ASSIGN_GSN( gsn_arteries, "arterias" );
        ASSIGN_GSN( gsn_backstab, "apunyalar" );
        ASSIGN_GSN( gsn_circle, "rodear" );
        ASSIGN_GSN( gsn_tumble, "caer" );
        ASSIGN_GSN( gsn_dodge, "esquivar" );
        ASSIGN_GSN( gsn_displacement, "desplazamiento" );
        ...
        ASSIGN_GSN( gsn_gouge, "luchar sucio" );
        ASSIGN_GSN( gsn_poison_weapon, "envenenar arma" );
        ASSIGN_GSN( gsn_ball_of_fire, "bola de fuego" );
        ASSIGN_GSN( gsn_feign_death, "fingir muerte" );
        ASSIGN_GSN( gsn_disarm, "desarmar" );
        ASSIGN_GSN( gsn_enhanced_damage, "ataques poderosos" );
        ASSIGN_GSN( gsn_grendals_stance, "estilo de grendal" ); // Revisar
        ASSIGN_GSN( gsn_masters_eye, "ojos maestros" );

//      Start of custom skills
        ASSIGN_GSN( gsn_butterfly_kick, "patada voladora" );
        ASSIGN_GSN( gsn_knee, "rodillazo" );
        ASSIGN_GSN( gsn_ferocious_strike, "golpe feroz" );
        ASSIGN_GSN( gsn_elbow, "codazo" );
        ASSIGN_GSN( gsn_bull_spirit, "espiritu de toro" );
        ASSIGN_GSN( gsn_bear_spirit, "espiritu de oso" );
        ASSIGN_GSN( gsn_wolf_spirit, "espiritu de lobo" );
        ASSIGN_GSN( gsn_infectious_claws, "garras infecciosas" );
        ASSIGN_GSN( gsn_net, "net" ); // revisar, peta.
        ASSIGN_GSN( gsn_sharpen_claws, "garras afiladas" );
        ASSIGN_GSN( gsn_find_water, "encontrar agua");
        ASSIGN_GSN( gsn_stalk_prey, "cazar");
        ASSIGN_GSN( gsn_shroud_spirit, "espiritu sombrio" );
        ASSIGN_GSN( gsn_tame, "domar" );
        ASSIGN_GSN( gsn_beast_meld, "posesion de bestias" );
        ASSIGN_GSN( gsn_crushing_jaw, "mordisco triturador" );
        ASSIGN_GSN( gsn_maul, "mutilar" );
        ASSIGN_GSN( gsn_chilled_touch, "toque frio" );
        ASSIGN_GSN( gsn_frost_touch, "toque helado" );
        ASSIGN_GSN( gsn_icy_touch, "toque de hielo" );
        ASSIGN_GSN( gsn_chilled_ward, "proteccion de hielo" );
        ASSIGN_GSN( gsn_frost_ward, "proteccion helada" );
        ASSIGN_GSN( gsn_ice_ward, "proteccion de granizo" );
        ASSIGN_GSN( gsn_frigid_ward, "proteccion congelada" );
        ASSIGN_GSN( gsn_steed, "corcel" );
        ASSIGN_GSN( gsn_hog_affinity, "afinidad con cerdos" );
        ASSIGN_GSN( gsn_static_ward, "proteccion estatica" );
        ASSIGN_GSN( gsn_shocking_ward, "proteccion fisica" );
        ASSIGN_GSN( gsn_energy_ward, "proteccion energetica" );
        ASSIGN_GSN( gsn_lightning_ward, "proteccion electrica" );
        ASSIGN_GSN( gsn_poultice, "cataplasma" );
        ASSIGN_GSN( gsn_animal_form, "forma animal" );
        ...
        ASSIGN_GSN( gsn_righteous_blow, "golpe justo" );
        ASSIGN_GSN( gsn_maim, "desangrar" );
        ASSIGN_GSN( gsn_parry, "parar" );
        ...
        ASSIGN_GSN( gsn_fell, "talar" ); // revisar
        ...
        ASSIGN_GSN( gsn_conjure_elemental, "conjurar elemental" );
        ASSIGN_GSN( gsn_animal_companion, "llamar animal" );
        ASSIGN_GSN( gsn_lesser_skeleton, "reanimar esqueleto" );
        ASSIGN_GSN( gsn_extract_skeleton, "extraer esqueleto" );
        ASSIGN_GSN( gsn_judo, "judo" );
        ASSIGN_GSN( gsn_paralyze, "inmovilizar" );
        ASSIGN_GSN( gsn_judge, "juzgar" );
    ...
    for ( ;; ) {
        ...
        if ( area_version >= 8
             && ( pObjIndex->vnum == 16243 || pObjIndex->vnum == 16244 || pObjIndex->vnum == 16245
                  || pObjIndex->vnum == 11247 || pObjIndex->vnum == 11248
                  || pObjIndex->vnum == 11249 || pObjIndex->vnum == 11250
                  || pObjIndex->vnum == 16246 ) ) {
...
void load_rooms( AREA_DATA *tarea, FILE * fp )
{
    ...
    for ( ;; ) {
        ...
        if ( area_version >= 9 ) {
             ...
             * Assigned and log it
             */
            if ( VLD_STR( pRoomIndex->owner ) && str_cmp( pRoomIndex->owner, "Not Assigned" )
                 && !valid_pfile( pRoomIndex->owner ) )
                log_printf
                    ( "%s: Room (%d) has owner set to (%s), but there is no pfile to go with it.",
                      __FUNCTION__, vnum, pRoomIndex->owner );
        }
    ...
    for ( pArea = first_area; pArea; pArea = pArea->next ) {
        ...
        if ( pArea->nplayer > 0 && pArea->age == ( reset_age - 1 ) ) {
            ...
            if ( pArea->resetmsg )
                ...
                mudstrlcpy( buf, "Escuchas unos ruídos extraños...\r\n", MSL );
...
OBJ_DATA               *create_object( OBJ_INDEX_DATA *pObjIndex, int level )
{
    ...
    if ( pObjIndex->vnum == 16243 || pObjIndex->vnum == 16244 || pObjIndex->vnum == 16245
         || pObjIndex->vnum == 11247 || pObjIndex->vnum == 11248 || pObjIndex->vnum == 11249 ) {
        obj->cost = 6;
    }
    ...
    if ( pObjIndex->vnum == 16243 || pObjIndex->vnum == 16244 || pObjIndex->vnum == 16245
         || pObjIndex->vnum == 11247 || pObjIndex->vnum == 11248 || pObjIndex->vnum == 11249
         || pObjIndex->vnum == 11250 || pObjIndex->vnum == 16246 ) {
...
void free_char( CHAR_DATA *ch )
{
    ...
    if ( ch->pcdata ) {
        ...
        if ( VLD_STR( ch->pcdata->pareja ) )
		STRFREE( ch->pcdata->pareja );
...
void make_stafflist(  )
{
    ...
    snprintf( buf, MSL, "&C Administración de %s!", sysdata.mud_name );
    tostafffile( buf );
    buf[0] = '\0';
    ilevel = 65535;
    for ( staff = first_staff; staff; staff = staff->next ) {
        if ( staff->level < ilevel ) {
            ...
            switch ( ilevel ) {
                case MAX_LEVEL:
                    tostafffile( "      &CIMPLEMENTADOR&c" );
                    break;
                case LEVEL_AJ_COLONEL:
                    tostafffile( "      &CPROGRAMADOR&c" );
                    break;
                case LEVEL_AJ_MAJOR:
                    tostafffile( "      &CCOORDINADOR&c" );
                    break;
                case LEVEL_AJ_CAPTAIN:
                    tostafffile( "      &CJEFE DE CONCILIO&c" );
                    break;
                case LEVEL_AJ_LT:
                    tostafffile( "      &CJEFE DE CONCILIO&c" );
                    break;
                case LEVEL_AJ_SGT:
                    tostafffile( "      &CCREADOR&c" );
                    break;
                case LEVEL_AJ_CPL:
                    tostafffile( "      &CORGANIZADOR&c" );
                    break;
                case LEVEL_IMMORTAL:
                    tostafffile( "      &CAPRENDIZ&c" );
                    break;
                case MAX_LEVEL - 8:
                    tostafffile( "      &YTEMPORAL&P" );
                    break;
                case MAX_LEVEL - 9:
                    tostafffile( "      &rInvitado a 6 Dragones&P" );
                    break;
                case MAX_LEVEL - 10:
                    tostafffile( "      &CRetirado de 6 Dragones&c" );
                    break;
                default:
                    tostafffile( "      &WError&P" );
                    break;
            }
        }
...
char                   *distime( time_t updated )
{
    ...
    snprintf( buf, sizeof( buf ), "%3.3s %3.3s %2d %2d:%.2d:%.2d%2.2s %4.4d",
              ...
              hour, time->tm_min, time->tm_sec, am ? "AM" : "PM", ( time->tm_year + 1900 ) );
    return buf;
}
