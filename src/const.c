...
const struct liq_type   liq_table[LIQ_MAX] = {
    ...
    {"Poción negra", "negro", {0, 0, 0}},
    {"vómito", "verde asqueroso", {0, -1, -1}},
...
const char             *s_blade_messages[24] = {
    "falla", "rasca", "araña", "corta", "corta", "acuchilla", "rasga",
...
const char             *p_blade_messages[24] = {
    "fallas", "rascas", "arañas", "cortas", "cortas", "acuchillas", "rasgas",
...
const char             *s_blunt_messages[24] = {
    "falla", "roza", "araña", "daña", "golpea", "golpea", "causa magulladuras",
...
const char             *p_blunt_messages[24] = {
    "fallas", "rozas", "arañas", "dañas", "golpeas", "golpeas", "causas magulladuras",
...
const char             *s_generic_messages[24] = {
    "falla", "roza", "araña", "daña", "hiere levemente", "hiere", "magulla",
...
const char             *p_generic_messages[24] = {
    "fallas", "rozass", "arañas", "dañas", "hieres levemente", "hieres", "magullas",
