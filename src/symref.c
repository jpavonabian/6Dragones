...
DO_FUN                 *skill_function args( ( char *name ) )
{
    ...
    case 'c':
        ...
        if(!str_cmp(name, "do_casar")) return do_casar;
        if(!str_cmp(name, "do_cpareja")) return do_cpareja;
    ...
    case 'd':
        ...
        if(!str_cmp(name, "do_divorciar")) return do_divorciar;
    ...
    case 'h':
        ...
        if(!str_cmp(name, "do_hog_affinity")) return do_hog_affinity;
        if(!str_cmp(name, "do_heavy_hands")) return do_heavy_hands;
        if(!str_cmp(name, "do_holidays")) return do_holidays;
        break;
    case 'i':
        if(!str_cmp(name, "do_irpareja")) return do_irpareja;
    ...
    case 's':
        ...
        if(!str_cmp(name, "do_sharpen_claws")) return do_sharpen_claws;
...
const char             *skill_name( DO_FUN *skill )
{
    ...
    if(skill == do_hog_affinity) return "do_hog_affinity";
    ...
    if(skill == do_sharpen_claws) return "do_sharpen_claws";
    ...
    if(skill == do_cpareja) return "do_cpareja";
    if(skill == do_irpareja) return "do_irpareja";
    if(skill == do_divorciar) return "do_divorciar";
    if(skill == do_casar) return "do_casar";
