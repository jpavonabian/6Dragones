...
void do_setmssp( CHAR_DATA *ch, char *argument )
{
    ...
    if ( !str_cmp( arg1, "worlds" ) ) {
        ...
        if ( strcmp( argument, "None" ) && strcmp( argument, "Immortal Run" )
             && str_cmp( argument, "Automated" ) && str_cmp( argument, "Integrated" ) ) {
            ch_printf( ch,
        ...
        if ( strcmp( argument, "None" ) && strcmp( argument, "Accepted" )
             && str_cmp( argument, "Encouraged" ) && str_cmp( argument, "Enforced" ) ) {
        ...
        if ( strcmp( argument, "All Stock" ) && strcmp( argument, "Mostly Stock" )
             && str_cmp( argument, "Mostly Original" ) && str_cmp( argument, "All Original" ) ) {
            ch_printf( ch,
